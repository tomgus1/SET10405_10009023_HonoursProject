...
pub struct Theme {
    ...
    /// A secondary accent distinct from `surface`, for controls that need
    /// to stand out from plain/neutral ones without being a primary or
    /// danger action (e.g. a calculator's operator keys).
    pub operator: Hsla,
    pub selection: Hsla,
    pub cursor: Hsla,
