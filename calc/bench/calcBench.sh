...
RUST_PROJECT_DIR="${RUST_PROJECT_DIR:-$HOME/workspace/personal/university/honours/calc/rustcalc}"
RUST_BIN_NAME="${RUST_BIN_NAME:-rustcalc}"
...
RUSTFW_PROJECT_DIR="${RUSTFW_PROJECT_DIR:-$HOME/workspace/personal/university/honours/calc/rustfwcalc}"
RUSTFW_BIN_NAME="${RUSTFW_BIN_NAME:-rustcalc}"
...
JAVA_PROJECT_DIR="${JAVA_PROJECT_DIR:-$HOME/workspace/personal/university/honours/calc/javacalc}"
JAVA_JAR_PATH="${JAVA_JAR_PATH:-$HOME/workspace/personal/university/honours/calc/javacalc/target/java-calculator-1.0.0.jar}"
JAVA_MAIN_CLASS="${JAVA_MAIN_CLASS:-}"
JAVA_SRC_DIR="${JAVA_SRC_DIR:-$JAVA_PROJECT_DIR/src}"

FLUTTER_PROJECT_DIR="${FLUTTER_PROJECT_DIR:-$HOME/workspace/personal/university/honours/calc/fluttercalc}"
...
ELECTRON_PROJECT_DIR="${ELECTRON_PROJECT_DIR:-$HOME/workspace/personal/university/honours/calc/reactcalc}"
...
ELECTRON_RELEASE_DIR="${ELECTRON_RELEASE_DIR:-$ELECTRON_PROJECT_DIR/electron/release}"

RUNS=10
IDLE_SAMPLE_AFTER=3
IDLE_SAMPLE_DURATION=5
PROJECT_LABEL="${PROJECT_LABEL:-calc}"
